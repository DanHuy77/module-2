...
public class Villa extends Facility {
    ...
    public Villa(String serviceName, double serviceUsedArea, double rentalCost, int maximumUser, String rentalType, String serviceCode, String roomStandard, double poolArea, int floorNumber) {
